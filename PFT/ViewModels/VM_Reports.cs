    ...
    public partial class VM_Main : INotifyPropertyChanged
    {
        ...
        private void GetSumOfTransactions()
        {
            try
            {
                ...
                TotalMoneyIn = d.GetTransactionBalance(StartDate, EndDate, true);
                TotalMoneyOut = d.GetTransactionBalance(StartDate, EndDate, false);
            }
        ...
        /// </summary>
        private void GetPaymentTypeTotalSpend()
        {
            try
            {
                ...
                {
                    itm.TotalSpend = d.GetPaymentTypeTotalSpend(itm.Id, StartDate, EndDate, false);
                }
        ...
        /// <summary>
        /// Gets the total of transactions by Tag for the given date range
        /// </summary>
        private void GetTagTotalSpend()
        {
            try
            {
                ITagData d = new TagData();

                foreach (Tag itm in Tags)
                {
                    itm.TotalSpend = d.GetTagTotalSpend(itm.Id, StartDate, EndDate, false);
                }
        ...
        /// <summary>
        /// Gets the total of transactions by Items for the given date range
        /// </summary>
        private void GetItemTotalSpend()
        {
            try
            {
                IItemData d = new ItemData();

                foreach (Item itm in Items)
                {
                    itm.TotalSpend = d.GetItemTotalSpend(itm.Id, StartDate, EndDate, false);
                }
