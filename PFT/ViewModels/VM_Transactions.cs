...
namespace PFT.ViewModels
{
    public partial class VM_Main
    {
        ...
        /// <summary>
        /// Auto insert transactions from the TransactionAutoRepeat table
        /// </summary>
        private void autoInsertTransactions() 
        { 
            //go and check the list of AutoRepeats for something happening today
            //colTransactions
            TransactionAutoRepeatCol tarc = new TransactionAutoRepeatCol();
            


            //insert the auto transactions

            //update the Auto Insert LastDateInserted
